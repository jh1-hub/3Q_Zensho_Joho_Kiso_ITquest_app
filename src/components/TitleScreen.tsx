...
export default function TitleScreen({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-300 via-sky-100 to-emerald-100 text-slate-800 flex flex-col justify-between p-6 relative overflow-hidden font-sans select-none border-t-8 border-blue-600">
